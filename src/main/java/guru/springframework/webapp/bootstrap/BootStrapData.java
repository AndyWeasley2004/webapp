...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        publisherRepository.save(publisher); //after initialization, save is still required
        ...
        // save author and book we created to H2 database via repository extends from CrudRepository
